...
if(isset($_GET['notifcation'])) {
	mysql_query("delete from notifcation where ID=".$_GET['notifcation']);
}
?>
<!DOCTYPE html>
<html>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
			<ul>
                ...
                <li><a href="Update_passenger.php">Updatepassword</a></li>
				<li><a href="View Reservation.php">View Reservation</a></li>
				<li><a href='notfication2.php'>Notification</a></li>
...
$result6 = mysql_query("select *from user1 where user_id=".$row2['user_id']);
