...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
        ...
        <div id="tooplate_main">
           ...
           <h1 align="right">
<?php		
			$av=mysql_query("select *from report ");
...
<tr>
<th style='height:30px;	text-align:center; color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Plate_no</th>
<th style='height:30px;	text-align:center; color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>FullName</th>
<th style='height:30px;	text-align:center; color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Dates</th>
<th style='height:30px;	text-align:center; color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>entranceTime</th>
