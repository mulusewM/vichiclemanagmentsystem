...
<table>
	...
	$sel=mysql_query("SELECT * FROM users");
			echo '<table border="1" style="width:900px;height:300;color:black;border:1px solid #336699;border-radius:10px;" "border:2";id="vtable"><tr>';
			...
			echo"<br>";
			echo"<font color='blue'>There are &nbsp;</font><font color='red'>".$intt."&nbsp;</font>Users are registered";
			echo"<br><br>";
			echo'<p valign="bottom" align="right"><form><input type="button" style="width:30%;height:30px;color:#2E8B57;
					   text-transform:capitalize;Font-weight:bolder;font-size:15px"; value="Print" onclick="window.print();"></form></p>';	
