...
<div id="tooplate_wrapper">
    ...
    <?php		  
			...
			$passenger=mysql_query("select *from users where level='7'");
			$countpassenger=mysql_num_rows($passenger);
			
			echo '<font color="magneta"; size="4" ><center><h2><u>Information of Users</u></h2><br> There are '.$countadmin.'&nbsp;&nbsp;  Adminstrator,  '.$countmanager. '&nbsp;&nbsp; Manager ,  '.$countstaff. ' &nbsp;&nbsp; passenger,  '.$countpassenger. '&nbsp;&nbsp;Staff , &nbsp;&nbsp;&nbsp;'.$countofficer.'&nbsp;&nbsp;Officer , &nbsp;&nbsp;&nbsp;'.$countmechanic.'&nbsp;&nbsp;Mechanic and &nbsp;'.$countdriver.'&nbsp;&nbsp; Driver <br> Total number number of users is ' .($countadmin+$countmanager+ $countstaff+$countofficer+$countmechanic+$countdriver+$countpassenger).'.'.'</font>' ;
			echo"<br>";
   ?>
...
<td><?php
						...
						<?php
						print("<td style='height:30px;'><a href = 'deleteuser.php?key=".$ctrl."'><img width='15px' height='15px' src = 'images/actions-delete.png' title='Delete' onclick='isdelete();'><a href = 'modifyuser.php?user_id=".$ctrl."'></a></td>");
	                    ?>
		</tr>
<?php
  }
...
<!--Footer-->
		...
		<a href="http://www.tweeter.com"><img src="images/tweeter.png" id="tweeter"></a> 
            <div id="footp"><b>Copyright © 2011 E.C.  BURIE  TOWN BUS STATION</span><br/><br/></b>Online Vehicle Management System</h2></div>
