...
<div id="tooplate_wrapper">
 ...
 <center>
<form action="Request_services.php" method="post">
<p><font size="5" color="magneta"><u> Request service</u></font></p>
<table align="center"style="color:black">

<tr><td style="padding-top:12px;">User_ID:</td><td style="padding-top:12px;"><input type='text' name='user_id' required x-moz-errormessage="Enter user ID" "<?php echo "$user_id"?>"></td></tr>

<tr><td style="padding-top:12px;">Number Of Traveller:</td>
...
<tr>   
              ...
              <td style="padding-top:12px;"><select name="Start"  style="width:136px;" required x-moz-errormessage="Enter Your Place Start" required maxlength="5">
                  <option ></option>
...
<td style="padding-top:12px;" ><input type="date" name="Entrance" title="Enter Id for search " id="date-pick" placeholder ="date-month-year" class="search" autocomplete="off"required x-moz-errormessage="Please Select Entrance date" title="Please Select Entrance date"/></td>
</tr>
  <td style="padding-top:12px;">Outgoing Time :</td>
<td style="padding-top:12px;"><select name="time" id="time"  style="width:90px;"  required x-moz-errormessage="Please Select Time" title="Please Select Time">
   ...
   <tr><td style="padding-top:12px;"> Request Reason:</td>
...
<?php
 ...
 $Traveller=$_POST['Traveller'];
 	$sql="INSERT INTO  servicerequests ( user_id,Traveller, RequestDate,PlaceStart,PlaceArrival,Outgoingdate,Entrancedate,OutgoingTime,RequestReason,RequestStatus)";
...
echo' <meta content="4;officer.php" http-equiv="refresh" />';	
}
