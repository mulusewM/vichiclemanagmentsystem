...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
			<ul>
				...
				<li><a href='notifcation.php'><span> view Notification<?php $av = mysql_query("SELECT * FROM assignvehicle where status='unread'");
...
if (!mysql_query($sql,$conn))
  ...
  die('Error: ' . mysql_error());
		...
		echo "<script>alert(' your comment sent successfully!');</script>"; 
         echo' <meta content="5;submit_comment.php" http-equiv="refresh" />'; 
		 }
mysql_close($conn)
?>
<!--Footer-->
