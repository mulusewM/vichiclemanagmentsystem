...
<div id="tooplate_wrapper">
	<div id="tooplate_header">
       	   <div id="site_title"><h2 id="hheader"style="margin-left:180px;margin-top:40px;font-size:22px;font-family:Cooper Black;"><b><span style="font-size:36px;color:white">   Burie Town Bus Station</span><br/><br/></b>Online Vehicle Management System Admin page</h1></div>
		 ...
		 <h3>Welcome To Online Vehicle Management System For Burie Town Bus Station</h3>
			...
			<div id="wowslider-container1"style="margin-top:60px;" >
				...
				<div class="ws_bullets">
					<div>
						<a href="#" title="Mtu Getway"><span><img src="data1/images/1.jpg" alt="1"/>1</span></a>
						...
						<a href="#" title="BTBS"><span><img src="data1/tooltips/9.jpg" alt="9"/>7</span></a>
						...
						<a href="#" title="car in Town"><span><img src="data1/tooltips/15.jpg" alt="15"/>12</span></a>
					</div>
				</div>
...
<font size="3" color="red">
<br><b>BR6:</b> The manager should approve the request of the officer and staff.
</font>
<font size="3" color="yellow">
