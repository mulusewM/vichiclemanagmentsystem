...
<tr> <td style="padding-top:12px;"> User_id:</td>
		   <td style="padding-top:12px;"><select  name="User_id" style="width:100px;"  required x-moz-errormessage="Enter  Full Name"  maxlength="5">
<?php
$result=mysql_query("select * from  servicerequests where RequestStatus='YES'")or die(mysql_error);
...
<tr> <td style="padding-top:12px;"> Vehicle Plate No.:</td>
     <td style="padding-top:12px;"><select  name="Plate_no" style="width:100px;"  required x-moz-errormessage="Enter  Full Name"  maxlength="40">
<?php
...
<?php
$result=mysql_query("select * from  users where level='6'")or die(mysql_error);
while($row=mysql_fetch_array($result)){
...
<tr><td style="padding-top:12px;">Place Start :</td>
     <td style="padding-top:12px;"><select name="Starts"  style="width:150px;" required x-moz-errormessage="Enter Your Place Start" required maxlength="20">
     <option selected=selected ></option>
	  <option value='burie town'>burie town</option>
	
                </select></td>
              </tr>
<tr><td style="padding-top:12px;">Place Arrival:</td>
    <td style="padding-top:12px;"><select name="Arrival" style="width:150px;"required x-moz-errormessage="Enter Your Place Arrival" id="crhr"/>
	<?php
    $result=mysql_query("select * from  servicerequests where RequestStatus='YES'")or die(mysql_error);
    while($row=mysql_fetch_array($result)){
     echo "<option value=".$row['PlaceArrival'].">".$row['PlaceArrival']."</option>";
}
?>
                </select>
	</td></tr>
...
<td style="padding-top:12px;"><input type="date" name="Outgoing" title="Enter Id for search " id="date-pick" placeholder ="year-month-date" class="search" autocomplete="off" required x-moz-errormessage="Please Select  date" title="Please Select  date"/></td>
...
<td style="padding-top:12px;"> Request Reason:</td> 
 <td style="padding-top:12px;"><textarea rows="6" cols="30" align="center" name="Reason" id="Reason" placeholder='Write Assign reason here..' required x-moz-errormessage="Enter Message"></textarea></td>     
</tr>		  
</table>	
</center>  
