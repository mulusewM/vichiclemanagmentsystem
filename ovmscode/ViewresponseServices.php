...
<table align="center" style="border-radius:15px;border:1px solid #336699;box-shadow:1px 1px 10px black;">
			<tr>
				<td>
						<form action="ViewresponseServices.php"  method='POST'>
						<table>
 ...
 {
					$vid=$_POST['searchs'];
					$sql= "SELECT * FROM  serviceresponses where user_id='$vid'";
					$result=mysql_query($sql);
					$count=mysql_num_rows($result);
					if($count<1)
					{
					echo('<font color="red">This ID Number is not found</font>');
					echo'<meta content="5;ViewresponseServices.php" http-equiv="refresh" />';
					}
					else
					{
					echo"<center>";
