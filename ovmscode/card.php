...
$amount=$_POST['amount'];
//$sender account=$_POST['sender account'];
//$oganzation account=$_POST['oganzation account'];
 ...
 ?>
      ...
      <div class="cell example example4" id="example-4" style="height:500px;">
          ...
          <fieldset>
           ...
           <!-- <legend class="card-only" data-tid="elements_examples.form.pay_with_card">Pay with card</legend>-->
            ...
            <div class="container">
              ...
              <button type="submit" data-tid="elements_examples.form.donate_button" name="donate">submit</button>
            </div>
          </fieldset>
       ...
       <p class="message"><span data-tid="elements_examples.success.message"> Name :  </span><span class="name" id="yourname"><?php echo $name ?></span></p>
          <p class="message"><span data-tid="elements_examples.success.message"> Phone Number :  </span><span class="name" id="youramount">Rs. <?php echo $amount ?></span></p>
          <p class="message"><span data-tid="elements_examples.success.message"> Amount :  </span><span class="name"><?php echo $phone ?></span></p>
          <p class="message"><span data-tid="elements_examples.success.message"> sender account :  </span><span class="name" id="youremail"><?php echo $email ?></span></p>
		  <p class="message"><span data-tid="elements_examples.success.message"> oganzation account :  </span><span class="name"><?php echo $phone ?></span></p>
