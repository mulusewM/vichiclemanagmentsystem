...
<td><?php echo $VehicleStatus;?></td>	
		<td><?php
						...
						?>
                        		...
                        		<img src="images/deactivate.png" id="view" width="16" height="16" alt="" /><font color='blue' size='4'>Wait </a>
                        <?php
						}
						...
						?>
                       			 ...
                       			 <img src="Images/activate.png" width="16" id="view" height="16" alt=""  /><font color='blue' size='4'> Approve </a>
                        <?php
						}
                        ?>
						</td>
