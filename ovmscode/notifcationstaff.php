 ...
 function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='notifcationstaff.php');
   }
   else
   {
   return false;
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
			<ul>
				...
				<li><a href='notifcationstaff.php'><span>Notification
				<?php $av = mysql_query("SELECT * FROM assignvehicless where status='unread'");
...
<?php
$result = mysql_query("SELECT * FROM assignvehicless ORDER BY SID DESC");
...
?>	
						<?php
						print("
		<td style='height:30px;'><a href = 'open_notificationstaff.php?key=".$ctrl."'>Open</a></td>
		");
						print("
		<td style='height:30px;'><a href = 'deletenotificationstaff.php?key=".$ctrl."'>delete</a></td>
		");?>
		</tr>
<?php
  }
