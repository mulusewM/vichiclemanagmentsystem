...
<div id="tooplate_wrapper">
	<div id="tooplate_header">
       	   <div id="site_title"><h2 id="hheader"style="margin-left:180px;margin-top:40px;font-size:22px;font-family:Cooper Black;"><b><span style="font-size:36px;color:white">    BURIE TOWN BUS STATION</span><br/><br/></b>Online Vehicle Management System Staff Page</h2></div>
    ...
    <div id="tooplate_main" class="shadow">
		 ...
		 <h2>Welcome To Online Vehicle Management System For Burie Town Bus Station</h2>
...
<font size="3" color="Yellow">
<br><b>BR3:</b>  Users of the system must have proper user name and password in order to login the system.
</font>
<font size="3" color="red">
...
<font size="3" color="red">
<br><b>BR6:</b> Vehicles should be maintained when they are damaged or based on schedule maintenance report.
</font>
<font size="3" color="yellow">
<br><b>BR7:</b>ystem  assigned the vehicle and automatically sends notification for driver and requester office.
	</font>
	</marquee>	
</ul>	
			</div>
